...
CollectionReference farmers = FirebaseFirestore.instance.collection('farmersDB/0/farmers');
CollectionReference farmerDB = FirebaseFirestore.instance.collection('farmersDB');
...
Future<String> addFarmer(fullName,phoneNo,addr,city,state,pin) async {
  ...
  var counter=await farmerDB.doc('0').get().then((DocumentSnapshot documentSnapshot){
